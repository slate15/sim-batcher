...
def createExhibitionSetupScript(home_team_code, away_team_code):
	...
	if DSFL_TEAM_LIST[home_team_code] > 0:
		script += "Send {Down " + str(DSFL_TEAM_LIST[home_team_code]) + "}\n" # Navigate to home team within dropdown menu

	script += "Send {Tab}\n" # Select away team
	script += "Send {Up}\n" # Navigate to top of away team dropdown menu

	if DSFL_TEAM_LIST[away_team_code] > 0:
		script += "Send {Down " + str(DSFL_TEAM_LIST[away_team_code]) + "}\n" # Navigate to away team within dropdown menu
